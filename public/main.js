...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function () {
	    ...
	    $('.button').on('click', function (event) {
	        ...
	        if ($(this).hasClass('button_inactive')) $(this).removeClass('button_inactive');else $(this).addClass('button_inactive');
	    });
	});
	...
	$(function () {
	    ...
	    $('.percentage__active-border').each(function () {
	        ...
	        var timer = setTimeout(function changePerc() {
	            ...
	            if (i * 3.6 <= 180) $activeBorder.css('background-image', 'linear-gradient(' + (90 + i * 3.6) + 'deg, transparent 50%, #fff 50%), linear-gradient(90deg, #fff 50%, transparent 50%)');else $activeBorder.css('background-image', 'linear-gradient(' + (i * 3.6 - 90) + 'deg, transparent 50%, #e75735 50%), linear-gradient(90deg, #fff 50%, transparent 50%)');
	            if (++i <= perc) timer = setTimeout(changePerc, timeTick);
	        }, timeTick);
	    });
	});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3)))
